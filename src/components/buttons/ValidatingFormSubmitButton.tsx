...
const ValidatingFormSubmitButton: React.FC<IValidatingFormSubmitButton> = ({
  ...
  const baseStyles = `
    py-2 px-4 rounded-md text-white text-sm md:text-md transition cursor-pointer disabled:cursor-not-allowed flex justify-center items-center gap-3
  `;

  const enabledStyles = `
    bg-purple-500 hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2
  `;
